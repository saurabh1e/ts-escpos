...
func TestHandlePrintBlocksDuplicatesUnlessOverrideIsEnabled(t *testing.T) {
	...
	waitForStatus(t, printStore, buildPrintDedupeKey("bill", "INV-1001", "STORE-7", nil, "Test Printer", ""), jobs.StatusFailed)
	...
	waitForPrint(t, printDone)
	waitForStatus(t, printStore, buildPrintDedupeKey("bill", "INV-1001", "STORE-7", nil, "Test Printer", ""), jobs.StatusSuccess)
